...
function runBaseTests() {
  sd_keen_vis_1 = document.getElementById('sd_keen_vis_1');

  suite('Base Automation Tests for sd-keen-vis', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('sd-keen-vis fixture is created', function() {
      assert.isTrue(document.getElementById('sd_keen_vis_1') !== null);
    });
